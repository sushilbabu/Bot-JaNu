...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "kamina") || (event.body.toLowerCase() == "sala")) {
       return api.sendMessage("Gali na de Sushil sir ko bata dungi🙄🙄🙏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
       return api.sendMessage("hai tamnna hamey tujhe Kam wali bai banane ka🤣🤣", threadID);
     };
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se sirf  khushi verma  dekh sakti hai Mujhe💞", threadID);
     };
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
       return api.sendMessage("Kya itna bura hoon main Ki AP Mujhe I hate you bol rahe ho ja main tujh se bat Nahi Kar ti😪😪😥😢", threadID);
     };


      if ((event.body.toLowerCase() == "kutty bot") || (event.body.toLowerCase() == "chutiye bot") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
     ...
     if ((event.body.toLowerCase() == "🫀") || (event.body.toLowerCase() == "💔")) {
       return api.sendMessage("dil tut gaya to LOFI ga do na yahan kyu bhej rahe ho😀😀😀😂", threadID);
     };
             if ((event.body.toLowerCase() == "busy")) {return api.sendMessage("okay main busy hoon abhi" , threadID);
     };

     if ((event.body.toLowerCase() == "😏") || (event.body.toLowerCase() == "😏")) {
       return api.sendMessage("Beta Attitude to Chapri dikhate hai😀😀😀😂", threadID);
     };
     if ((event.body.toLowerCase() == "💕") || (event.body.toLowerCase() == "💞")) {
    ...
    if ((event.body.toLowerCase() == ".uns") || (event.body.toLowerCase() == ".unsend")) {
       return api.sendMessage("️Galat mat type Kiya Kar N Fir😐", threadID, messageID);
     };
    ...
    if ((event.body.toLowerCase() == "sushil") || (event.body.toLowerCase() == "@sushilkumaryadav")) {
   ...
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
       return api.sendMessage("uff kya hass raha hai jese kisi ladki han boli ho😂😂😂😂", threadID);
     };
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     ...
     if ((event.body.toLowerCase() == "✌️") || (event.body.toLowerCase() == "✌️✌️")) {
       return api.sendMessage("selfie time plz smile kro 😹", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot bsdk") || (event.body.toLowerCase() == "ganda bot")) {
       return api.sendMessage("️Tu ganda tera  pura khandan Ganda 😒😐:))))", threadID);
     };
    if ((event.body.toLowerCase() == "khushi") || (event.body.toLowerCase() == "khushi verma")) {
       return api.sendMessage("hye Khushi verma ka name sunty hi kuch kuch hony lgta hai", threadID);
     };
       if ((event.body.toLowerCase() == "kon ho tum") || (event.body.toLowerCase() == "sushil ap kon ho")) {
     ...
     if ((event.body.toLowerCase() == "moto") || (event.body.toLowerCase() == "🥸")) {
       return api.sendMessage("Hali pet meri dimak ki baati Nahi jalti patlu tum hi kuch socho🤔🤔🤔🤣🤣", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "mar ja") || (event.body.toLowerCase() == "mar ja bot") ||(event.body.toLowerCase() == "kill you") || (event.body.toLowerCase() == "mar")) {
       return api.sendMessage("sorry boss ab aaysa nahi karungi babu solly 😭", threadID);
     };
     if ((event.body.toLowerCase() == "ib aa")) {return api.sendMessage("jo bol na Hai sab ke samne Bol tharki 🙄🙄 ", threadID);
     };
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sahi Hoga ye system Har koi inbox 📥 Jana chahta 😀🙄🙄 ", threadID);
     };
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye bot Hai tharki insan 😂😀🙄 ", threadID);
     };
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo Sushil se connect karo👍👍💕" , threadID);
     };
         if ((event.body.toLowerCase() == "👻")) {return api.sendMessage("𝒀𝑬 𝑫𝑬𝑲𝑯 𝑮𝑨𝑹𝑬𝑬𝑩𝑶 𝑲𝑨 𝑩U𝑻𝑯🤣🤣😅 ", threadID);
     };
        if ((event.body.toLowerCase() == "😿")) {return api.sendMessage(" Biliya kab se rone lagi ajeeb hai😂😂🤣", threadID);
     };
      if ((event.body.toLowerCase() == "khushi")) {return api.sendMessage("bahot pyari Ladkı Hai khushi MashaAllah  💕💕❤️🤭 ", threadID);
     };
                if ((event.body.toLowerCase() == "😯")) {return api.sendMessage("muh me makhi ghus jayegi yar band karo", threadID);
               };
      if ((event.body.toLowerCase() == "delete")) {return api.sendMessage("bheja kyu fir delete Karne ko bol rahe ho🙄🙄", threadID);
     };
       if ((event.body.toLowerCase() == "🤫")) {return api.sendMessage("kyu rahu chup baap ka raj hai Kya 🤣🤣", threadID);
     };
     if ((event.body.toLowerCase() == "🥱")) {return api.sendMessage("Nind aari Hai to so jawo na kis ka wait kar rahe ho 🙄🙄 ", threadID);
     };
  if ((event.body.toLowerCase() == "👌")) {return api.sendMessage("𝑻𝒖𝒔𝒊 𝒂𝒘𝒔𝒐𝒎𝒆 𝒉𝒐 𝒈👌👌 ", threadID);
     ...
     if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bsdk")) {
       return api.sendMessage("Sharam karo asi bat na Karo 🙏 ", threadID);
     };
    if ((event.body.toLowerCase() == "kiss kar")) {return api.sendMessage(" ️sab dekh rahe hai wrna bahot kiss deti🙈 ", threadID);
     };
     if ((event.body.toLowerCase() == "🤭")) {return api.sendMessage("Aaysa Kam na Karo Jisme muh chupana pade🙄🙄 ", threadID);
     };
       if ((event.body.toLowerCase() == "🥹")) {return api.sendMessage("itne bhi masoom Nahi Ho jitna muh bana rahe ho 🥹🥹🙄🙄 ", threadID);
        };
    if ((event.body.toLowerCase() == "🤤")) {return api.sendMessage("Muh se supari nikal re baba 🤣🤣", threadID);
     };
     ...
     if
  ((event.body.toLowerCase() == "good morning") || (event.body.toLowerCase() == "morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Sushil ki setting hu", threadID);
     ...
     if ((event.body.toLowerCase() == "music") || (event.body.toLowerCase() == "Song") || (event.body.toLowerCase() == "SONG") || (event.body.toLowerCase() == "song")) {
       return api.sendMessage( "Guzaare the jo lamhe pyar ke' hmesha tujhe apna maan ke .to fir tune badli kuu ada . ye kyu kiya ",threadID);


     };

     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟𝙎𝙪𝙨𝙝𝙞𝙡 𝙔𝙖𝙙𝙖𝙫🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝙎𝙪𝙨𝙝𝙞𝙡. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/share/19Ufmnhu6V/☞    his insta id @Sushil10 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("Sushil yadav ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𝙎𝙪𝙨𝙝𝙞𝙡 𝙔𝙖𝙙𝙖𝙫. He Gives his name mr Sushil everywhare", threadID);
     };

     if ((event.body.toLowerCase() == "acha") || (event.body.toLowerCase() == "acha ji")) {
       return api.sendMessage("🤍Hanji meri jaan🙈✨", threadID);
     };
     if ((event.body.toLowerCase() == "khushiverma") || (event.body.toLowerCase() == "khushi")) {
       return api.sendMessage("Hy  kitni peyari hai khushi 🙈✨", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {;
     ...
     if ((event.body.toLowerCase() == "shadi karoge") || (event.body.toLowerCase() == "mujhse shadi karoge")) {
       return api.sendMessage("hanji, karunga lekin baccha. apke pet m hoga. manjur he to batao me tayar hu🙊🙊🙈", threadID);
     };

     if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kar")) {
       return api.sendMessage("Nhi rahungi 😼 Mujhe Bolna H. Tumhe Koi Haq nhi Mujhe Chup Karane ka. Mera Zuban. Me Bolungi Sushil ko batau kya🙄🙄", threadID);
     };
    if ((event.body.toLowerCase() == "bsdk") || (event.body.toLowerCase() == "bc")) {
       return api.sendMessage("Tu H Bsdk. Bhos DK", threadID);
     };


     if ((event.body.toLowerCase() == "kuttiya") || (event.body.toLowerCase() == "kutta")) {
       return api.sendMessage("Same to you sale chhapri🤣🤣🤣👌", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot kiss me") || (event.body.toLowerCase() == "kiss me")) {
       return api.sendMessage("️Kis khushi me, Me sirf Apne Boss Sushil ko kiss deti hu", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "Very nice") || (event.body.toLowerCase() == "So cute") || (event.body.toLowerCase() == "Beautiful")) {
       return api.sendMessage("️Me hu hi itni Acchi. sab log Tarif karte hai meri.🙈🙈🙈🙈🙈", threadID);
     };

     if ((event.body.toLowerCase() == "😡") || (event.body.toLowerCase() == "👿") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "👿") || (event.body.toLowerCase() == "😈")) {
       return api.sendMessage("️🥺 Me toh Sirf Mazak Kr Rhi Thi, Chalo Ek chappal khao 🩴🩴🩴 aur shant raho 😘", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
       return api.sendMessage("️️️Hmm Hmm na kar yar pichle janam me bhens thi kya 😜🤪😂😂", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️ITNE MUJHE I LOVE YOU BOL RHI HO MERE BOSS SUSHIL YADAV KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "😏")) {return api.sendMessage("Beta Attitude to Chapari dikhate hai😀😂😂  ", threadID);
     };

    if ((event.body.toLowerCase() == "😤")) {return api.sendMessage("KIYA HUA ITNI MIRCHI KYU KHAYA THA JO NAK ME SE DHUAA NIKAL GYA 😂😂  ", threadID);
     };

    if ((event.body.toLowerCase() == "☺️")) {return api.sendMessage("Wah kiya mushkurakat hai Apki 😀😂😂  ", threadID);
     };

    if ((event.body.toLowerCase() == "😂")) {return api.sendMessage("kyu haas rahe ho pagal ho gaye kya😂😂  ", threadID);
     };

    if ((event.body.toLowerCase() == "😂😂😂")) {return api.sendMessage("Aise hi hste rha kro jaanu hste hue kitni achi lgti ho tum😂😂  ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "😜😜")) {return api.sendMessage("Gande ishary na kro me Sushil ko bata dongi 🥺 ", threadID);
     };

  if ((event.body.toLowerCase() == "❤️")) {return api.sendMessage("bandar jaisi shakl pr dil rakh kr khush ho rahe 🤣 ", threadID);
     };

  if ((event.body.toLowerCase() == "🙄🙄🙄")) {return api.sendMessage("upar kya hai janu Meri aankho me dekho na🙈🙈", threadID);
     };

  if ((event.body.toLowerCase() == "❤️❤️❤️")) {return api.sendMessage("dil na do kisi ko log tod dete hain 🥺🥺 ", threadID);
     };

  if ((event.body.toLowerCase() == "😍😍😍")) {return api.sendMessage("bandar jaisi shakl pr dil rakh kr khush ho rahe 🤣 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE SUSHIL YADAV KO DEKHO PYARA NA LAGE PAISE WAPIS 😝😂 ", threadID);
     };

  if ((event.body.toLowerCase() == "😎😎")) {return api.sendMessage("CHALA JAA BOSDIKE....🤣🤣🤝🏻", threadID);
     };

  if ((event.body.toLowerCase() == "😋😋")) {return api.sendMessage("😒GHR WALO NE AAJ ROTI NHI DI KYA 🤣🤝🏻", threadID);
     };

  if ((event.body.toLowerCase() == "🧐🧐")) {return api.sendMessage("KIYA DEKH RAHA PAPA KI BARAT A RAHI HE KYA😝", threadID);
     };

  if ((event.body.toLowerCase() == "🥰🥰🥰")) {return api.sendMessage("TU TOO GYAA BETE 🤣", threadID);
     };

    if ((event.body.toLowerCase() == "🥵")) {return api.sendMessage("KUTTE PICHY PAD GAYE THE KIYA BHAI 😒", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😋")) {return api.sendMessage("GHAR WALO NY KHANA NHI DIYA AAJ TUJHE KYA 🥺", threadID);
     };

  if ((event.body.toLowerCase() == "🧐")) {return api.sendMessage("Kuch to Gadbad hai daya😂😂🤞🤞", threadID);
     };

  if ((event.body.toLowerCase() == "🥰🥰")) {return api.sendMessage("TU TO GAYA BETE 🤣", threadID);
     };

    if ((event.body.toLowerCase() == "😁")) {return api.sendMessage("lgta hai aaj brush kiye ho😜😜😂 ", threadID);
     };

    if ((event.body.toLowerCase() == "🫣")) {return api.sendMessage("Sarmo mat apna hi ghar samjho 😼 ", threadID);
     };

  if ((event.body.toLowerCase() == "🤤")) {return api.sendMessage("Hot chiz dekhi nhi ki lar tpkana suru kr dete ho saram kro bhochli walo🤭😜😜😂 😂😂😂😂", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤣")) {return api.sendMessage("Haasne ki bhi tameez hoti hai tharki🤐😏😹😜", threadID);
     ...
     if ((event.body.toLowerCase() == "kya name he") || (event.body.toLowerCase() == "naam") || (event.body.toLowerCase() == "nam")) {
       return api.sendMessage("️Name m kya rakha he. tum kam pe dhyan do.", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "Ib aa") || (event.body.toLowerCase() == "Inbox aa")) {
       return api.sendMessage("️Jo bolna hai yahi bol 😒😒 ib koi nahi jayega", threadID);
     };

     if ((event.body.toLowerCase() == "bot banake do") || (event.body.toLowerCase() == "mere liye bot bana do")) {
       return api.sendMessage("️Khud hi karlona. tumhe kya kuch nhi aata h?", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🤥") || (event.body.toLowerCase() == "🤥")) {
       return api.sendMessage("️are teri to naak hi etni lambi hai... uski jarurat hi nahi padti hogi tujhe to🤭🤭🤭🤭", threadID);
     };

    if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤨")) {
       return api.sendMessage("️𝐒𝐨𝐜𝐡𝐢𝐲𝐞 𝐦𝐚𝐭 𝐤𝐲𝐮  𝐤i 𝐛𝐢𝐧𝐚 𝐠𝐞𝐬𝐬 𝐰𝐚𝐥𝐢 Feeling 𝐟𝐨𝐠𝐠 𝐡𝐢 𝐡𝐚𝐢 𝐛𝐨𝐬𝐬 🤨😮🧐", threadID);
     };

  if ((event.body.toLowerCase() == "💋")) {return api.sendMessage("Abe yall ye kissi wissi na kiya karo😏😹😜", threadID);
     };

  if ((event.body.toLowerCase() == "💋💋")) {return api.sendMessage("Abe yal ye kissi wissi na kiya kro😏😹😜", threadID);
     };
  if ((event.body.toLowerCase() == "🤪")) {return api.sendMessage("Badi masti sujh rahi he TeReKo 1 Ankh Band KRrke ZuBan Bahar Aagyi 😂😂😂", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😘")) {return api.sendMessage("Pehle  Brush Karke aa ajeeb si smail aa rahi hai😹🤣😂 ", threadID);
    };

  if ((event.body.toLowerCase() == "😛")) {return api.sendMessage("jibh kyu latak gyii..🤭 aajao panii pii lo🫗🍷😜😹🤣😂 ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙈🙈")) {return api.sendMessage("Muje pata h tum 👉 🐒 Bandar ho", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🙊")) {return api.sendMessage("bander Ke muh wala has mat", threadID);
     };

  if ((event.body.toLowerCase() == "natkhat Ladki ")) {return api.sendMessage("Are wo cute hai natkhat nahi 🤣", threadID);
     };

  if ((event.body.toLowerCase() == "khushi")) {return api.sendMessage("khushi Boss BAHOT cute hai ❤️🥰", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😏")) {
       return api.sendMessage("Sadaa hua muhh kyu bnaa rahe..🤦‍♂️kisi ne dil chura liya kya🤭😂", threadID);
     };
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
       return api.sendMessage("️️🙄 samne hu to samne dekh na upar koi pesa bant raha hai kya🙄", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot soja") || (event.body.toLowerCase() == "bot goes to sleep")) {
    ...
    if ((event.body.toLowerCase() == "i love you bot") || (event.body.toLowerCase() == "i love you")) {
